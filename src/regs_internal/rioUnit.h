...
#define SYSCONFIG_ROM0_SPEED_BSHIFT        __builtin_ctz(SYSCONFIG_ROM0_SPEED)
#define SYSCONFIG_ROM1_TYPE                0x08000000
#define SYSCONFIG_ROM1_MODE                0x04000000
#define SYSCONFIG_ROM1_SPEED               0x0c000000
#define SYSCONFIG_ROM1_SPEED_BSHIFT       __builtin_ctz(SYSCONFIG_ROM1_SPEED)
#define SYSCONFIG_MEM_SPEED                0x00300000
#define SYSCONFIG_MEM_SPEED_BSHIFT         __builtin_ctz(SYSCONFIG_MEM_SPEED)
#define SYSCONFIG_MEM_VENDOR               0x00300000
#define SYSCONFIG_MEM_VENDOR_BSHIFT        __builtin_ctz(SYSCONFIG_MEM_SPEED)
#define SYSCONFIG_AUD_DAC_TYPE             0x000c0000
#define SYSCONFIG_AUD_DAC_TYPE_BSHIFT      __builtin_ctz(SYSCONFIG_AUD_DAC_TYPE)
...
#define SYSCONFIG_SPOT_CPU_CLK_MULT_BSHIFT __builtin_ctz(SYSCONFIG_CPU_CLK_MULT)
#define SYSCONFIG_CPU_OBUFFER              0x00002000
#define SYSCONFIG_IS_NTSC                  0x00000800
#define SYSCONFIG_BOARD_REV                0x000000f0
#define SYSCONFIG_BOARD_REV_BSHIFT         __builtin_ctz(SYSCONFIG_BOARD_REV)
#define SYSCONFIG_BOARD_TYPE               0x0000000c
#define SYSCONFIG_BOARD_TYPE_BSHIFT        __builtin_ctz(SYSCONFIG_BOARD_TYPE)
...
#define SYSCONFIG_SOLO_CPU_CLK_MULT_BSHIFT __builtin_ctz(SYSCONFIG_CPU_CLK_MULT)
#define SYSCONFIG_CPU_DRIVE                0x00018000
#define SYSCONFIG_CPU_DRIVE_BSHIFT         __builtin_ctz(SYSCONFIG_SOLO_CPU_DRIVE)
...
#define ROM_CNTL_TIMING_INIT_ACCESS_BSHIFT __builtin_ctz(ROM_CNTL_TIMING_INIT_ACCESS)
#define ROM_CNTL_TIMING_PAGE_ACCESS        0x1f000000
#define ROM_CNTL_TIMING_PAGE_ACCESS_BSHIFT __builtin_ctz(ROM_CNTL_TIMING_PAGE_ACCESS)
#define ROM_CNTL_TIMING_NEXT_CE            0x00007000
#define ROM_CNTL_TIMING_NEXT_CE_BSHIFT     __builtin_ctz(ROM_CNTL_TIMING_NEXT_CE)
#define ROM_CNTL_TIMING_CE_TO_WE           0x00000300
#define ROM_CNTL_TIMING_CE_TO_WE_BSHIFT    __builtin_ctz(ROM_CNTL_TIMING_CE_TO_WE)
#define ROM_CNTL_TIMING_WE                 0x0000000f
#define ROM_CNTL_TIMING_WE_BSHIFT          __builtin_ctz(ROM_CNTL_TIMING_WE)
