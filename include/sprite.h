 ...
 * @ingroup graphics
 */
#ifndef __LIBWTV_SPRITE_H
#define __LIBWTV_SPRITE_H
 ...
 */
inline pixel_mode_t sprite_get_format(sprite_t *sprite) {
    return (pixel_mode_t)(sprite->flags & SPRITE_FLAGS_TEXFORMAT);
}
