 ...
 *
 * Code wishing to draw to the display should first acquire a display context
 ...
 * code has finished drawing to the display context, it can be drawn on the
 * display using #display_show.
 *
...
/**
 * @brief Same as graphics_fill_display in order to maintain some compatibility with libdragon
 */
#define graphics_fill_screen graphics_fill_display
 ...
 * @param[in] color
 *            The 32-bit RGBA color to draw to the display.  Use #graphics_convert_color
...
/**
 * @brief Fill the entire display with a particular color
 *
 * @note Since this function is designed for blanking the display, alpha values for
 * colors are ignored.
 *
 * @param[in] surf
 *            The currently active display context.
 ...
 *            or #graphics_make_color to generate this value.
 */
void graphics_fill_display( surface_t* surf, uint32_t c );
...
/**
 * @brief Draw a character to the display using the built-in font
 *
 * Draw a character from the built-in font to the display.  This function does not support alpha blending, 
 ...
 * @param[in] ch
 *            The ASCII character to draw to the display.
 */
 ...
 *
 * Draw a string to the display, following a few simple rules.  Standard ASCII is supported, as well
 ...
 *            The Y coordinate to place the top left pixel of the character drawn.
 * @param[in] msg
 *            The ASCII null terminated string to draw to the display.
 */
 ...
 * @param[in] sprite
 *            Pointer to a sprite structure to draw on the display.
 */
