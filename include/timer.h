 ...
 * @ingroup timer
 */
#ifndef __LIBWTV_TIMER_H
#define __LIBWTV_TIMER_H
 ...
 */
#define TIMER_TICKS_LL(us) ((long long)(us) * (TICKS_PER_US * 1000 * 1000) / 1000000)
/**
 * @brief Calculate microseconds based on timer ticks
 *
 * @param[in] tk
 ...
 */
#define TIMER_MICROS_LL(tk) ((long long)(tk) * 1000000 / (TICKS_PER_US * 1000 * 1000))
